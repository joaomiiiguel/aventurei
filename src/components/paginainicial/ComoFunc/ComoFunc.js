        ...
        <div className="FuncContainer">
            ...
            <div className="CardContainer">
                ...
                <div className="CardComoFun">
                    ...
                    <p>Dê uma olhada nas fotos, leia a descrição e as orientações do local.</p>
                </div>
                <div className="CardComoFun">
                ...
                <div className="CardComoFun">
                    ...
                    <p>Encontre-se com o Guia Aventurei na data e no local marcado e depois é só aproveitar a aventura.</p>
                </div>
            </div>
        </div>
    )
