...
export default function ComoFunc() {
    return (
        <div className="FuncContainer">
            <h2 style={{fontWeight:500}}>É muito simples como funciona</h2>
            <div className="CardContainer">
                <div className="CardComoFun">
                    <p style={{ fontSize: '70%' }}>Passo 1</p>
                    <img src={imgPasso1} className="imgComoFunc" />
                    <h3 className="titleCardComo">Pesquise a avetura ideal</h3>
                    <p>Faça sua busca detalhada para encontrar exatamente o que você deseja.</p>
                </div>
                <div className="CardComoFun">
                    <p style={{ fontSize: '70%' }}>Passo 2</p>
                    <img src={imgPasso2} className="imgComoFunc" />
                ...
                <div className="CardComoFun">
                    ...
                    <img src={imgPasso3} className="imgComoFunc" />
                ...
                <div className="CardComoFun">
                    ...
                    <img src={imgPasso4} className="imgComoFunc" />
