...
const Select = ({ options, value, onChange, className, placeholder }: { options: { value: string; label: string }[]; value: string; onChange: (value: string) => void, className?: string, placeholder?: string }) => {
    return (
